...
(function() {
  $('.question-upvote').on('ajax:success', function(e, data, status, xhr) {
    ...
    if ($(this).hasClass('upvoted')) {
      return $(this).removeClass('upvoted');
    } else {
      return $(this).addClass('upvoted');
    }
  });
  ...
  $('.question-downvote').on('ajax:success', function(e, data, status, xhr) {
    ...
    if ($(this).hasClass('downvoted')) {
      return $(this).removeClass('downvoted');
    } else {
      return $(this).addClass('downvoted');
    }
  });
...
(function() {
  $(document).on('ready page:load', function() {
    $(".topic .sidebar").stick_in_parent({
      offset_top: 20
    }).on("sticky_kit:stick", function(e) {
      return $(e.target).parent().css('width', function() {
        return 166;
      });
    });
    $(".topic .sidebar .tabs a").click(function() {
    ...
    return $('.exercise-navigation').css('width', function() {
      return $(this).find('li').size() * 40;
    });
  });

  $('.exercises .alternative').on('click', function(event) {
    var answer;
    event.preventDefault();
    $(".exercises .alternatives-for-" + ($(this).attr('data-exercise')) + " a").removeClass('active');
    answer = $(this).attr('data-answer');
    $(this).addClass('active');
    return $('.get_answer').attr('data-answer', function() {
      return answer;
    });
  });
  ...
  $('.exercises').on('after-slide-change.fndtn.orbit', function(event, orbit) {
    ...
    return $(".exercise-navigation li:nth-child(n + " + (exercise + 1) + ") a").removeClass('active');
  });

  $('.get_answer').on('click', function(event) {
    event.preventDefault();
    return $.ajax({
